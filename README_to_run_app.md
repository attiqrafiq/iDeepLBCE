...
### Step 1: The free streamlit based web app sleeps after one to two days of no traffic. If so, click the blue button titled as "Yes, get this app back up!"
...
#### Step 2: From home page, choose the Predict Page from the given menu to make predictions
<img alt="image predict page" src="readme_images/predictor1.png" />
<!-- width="1682" height="990" -->

#### Step 3: Paste any protein sequence in the Input Area or upload a file or choose from the sample provided data for easy and fast usage and then press Submit button.
...
#### You can encode the PSTPP features by putting the sequences at Encode Page either single, batch or by uploading a fasta file. After extracting features you can view and download features in csv format.
